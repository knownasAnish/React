...
const Experience = () => {
    ...
    const [animationName, setAnimationName] = useState('defeat')
                ...
                <div className="sm:py-10 py-5 sm:px-5 px-2.5">
                    {workExperiences.map(({ id, name, pos, icon, duration, title, animation }) => (
                        <div 
                            ...
                            onPointerOut={() => setAnimationName('defeat')}
                        >
                            ...
                            <div className="sm:p-5 px-2.5 py-5 ">
                                ...
                                <p className="text-sm mb-5 text-white-700">
                                    {pos} -- {duration}
                                </p>
                                <p className="group-hover:text-white transition ease-in-out duration-500 text-white-500">
                                    {title}
                                </p>
